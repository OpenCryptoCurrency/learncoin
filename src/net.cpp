...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Learncoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"learncointools.com", "127.0.0.1"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"learncointools.com", "testnet-seed.learncointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Learncoin is probably already running."), addrBind.ToString().c_str());
        else
